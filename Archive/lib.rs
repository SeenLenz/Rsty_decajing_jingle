pub mod gui {
    ...
    use eframe::{
        egui,
        egui::CentralPanel,
        egui::{style::Visuals, Layout, ScrollArea, SidePanel, TopBottomPanel},
        App,
    };
...
mod database_handling {
    ...
    CREATE TABLE IF NOT EXISTS playlists (
        ...
        date_created TEXT
            ...
            .expect("creation of playlists failed");
    ...
    ",
            ...
            .expect("creation of favourites failed");
    ...
    CREATE TABLE IF NOT EXISTS songs (
        ...
        FOREIGN KEY(favourite) REFERENCES playlists(id)
            ...
            .expect("creation of songs failed");
    ...
    fn sql_add_song(
        ...
        args: (i32, &str, &str, &str, &str, &str, i32, i32),
    ) -> Result<()> {
        connection.execute(
            "INSERT INTO songs VALUES(?1, ?2, ?3, ?4, ?5, ?6, ?7, ?8)",
    ...
    fn sql_create_playlist(
        connection: &Connection,
        args: (i32, &str, &str, i32, i32, &str),
    ) -> Result<()> {
        connection.execute(
            "INSERT INTO playlists VALUES(?1, ?2, ?3, ?4, ?5, ?6)",
